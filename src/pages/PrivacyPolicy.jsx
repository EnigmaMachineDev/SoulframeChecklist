  ...
  return (
    <div className="min-h-screen bg-sf-bg text-sf-text">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <p className="text-sf-muted text-xs font-sans mb-8">Last updated: February 15, 2026</p>
        ...
        <div className="space-y-8 text-sm leading-relaxed font-sans">
          ...
          <section>
            ...
            <p>
              Welcome to <strong className="text-sf-bright">Soulframe Progress Tracker</strong> (the "Website").
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              provide any personal information to use the tracker.
            </p>
            <h3 className="text-base font-bold text-sf-bright mb-2">Local Storage Data</h3>
            <p className="mb-3">
              Your checklist progress is saved exclusively in your browser's local storage. This data never
              leaves your device and is not transmitted to any server. You can clear this data at any time
              through your browser settings or by using the reset function within the tracker.
            </p>
          ...
          {/* Mediavine Programmatic Advertising — REQUIRED TEXT */}
          <section className="bg-sf-panel border border-sf-border rounded-xl p-6">
            ...
            <p className="mb-3">
              ...
              to learn more information about interest-based advertising. You may download the AppChoices app
              at{' '}
              <a
          ...
          <section>
            ...
            <p>
              Since this Website stores your checklist data locally on your device and does not collect
